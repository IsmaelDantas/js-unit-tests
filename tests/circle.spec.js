...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  //it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    it('Verifica se circle retorna undefined, caso a função não receba um número', () => {
    ...
    it('Verifica se circle retorna 3 propriedades', () =>  {
    ...
    it('Verifica se dentro do objeto a função retorna uma key com value certo de uma circumferência igual a 2', () => {
    ...
    it ('Verifica se dentro do objeto a função retorna uma key com value certo de uma área', () => {
